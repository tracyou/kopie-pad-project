class contactsFilterMeetController {
    constructor() {
        this.userRepository = new UserRepository();
        this.contactsFilterMeetRepository = new contactsFilterMeetRepository();

        $.get("views/filterViews/contactsMeet.html")
    ...
    async fetch() {
        ...
        try{
            ...
            try {
                const data = await this.contactsFilterMeetRepository.get(idUser);
